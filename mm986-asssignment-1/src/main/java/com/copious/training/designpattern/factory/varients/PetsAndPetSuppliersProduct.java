 ...
 * @author Mahesh More
 * <p>
 * Product Factory to get Products by PETS_AND_PET_SUPPLIES Category.
 */
@Component
public class PetsAndPetSuppliersProduct implements Product {
    ...
    public List<Sku> getProducts(List<Sku> products) {
        return products
                .stream()
                .filter(sku -> ProductCategoryEnum.PETS_AND_PET_SUPPLIES.equals(sku.getCategory()))
